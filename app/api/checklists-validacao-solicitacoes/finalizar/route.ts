...
function missingSolicitacaoId() {
  return NextResponse.json({
    ...
    expected: '/api/checklists-validacao-solicitacoes/{id}/finalizar',
    example: '/api/checklists-validacao-solicitacoes/ad937650-23e4-48ef-b714-9e250a71414e/finalizar',
  }, { status: 400 })
}
